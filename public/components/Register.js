    ...
    const ingPass = async () => {
        ...
        if(errors<=0){
            try {
                ...
                var result;
                const res = await axios.post('http://10.0.2.2:3088/api/lead/registerLead', { "name": tv1, "lastname":tv2, "secondLastname":tv3, "email":tv4, "phone":tv5, "isClient": false});
                result = res.data;
                alert(result.msg)
                if(result.success){
                ...
                <View style={{flex:1.5}}>
                    <View style={styles.container2}>
                        ...
                        <View style={{marginVertical:hp('0.7%')}}>
                            ...
                            <TextInput maxLength={8} placeholder="########" style={([styles.input, {borderWidth:cti5}])} value={tv5} onChangeText={(textValue) => {stv5(textValue), sct5(0)}}/>
                        </View>
